...
<head>
    <title>Code coverage report for publish.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> publish.js</h1>
        <div class='clearfix'>
...
&nbsp;
  if (!dryRun) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (manifest.publishConfig)
      Object.assign(opts, publishConfigToOpts(manifest.publishConfig))
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Wed Oct 28 2020 10:32:21 GMT-0700 (Pacific Daylight Time)
            </div>
        </div>
