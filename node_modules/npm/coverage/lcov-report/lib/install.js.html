...
<head>
    <title>Code coverage report for lib/install.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> install.js</h1>
        <div class='clearfix'>
...
&nbsp;
const cmd = async (args, cb) =&gt; install(args).then(<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >cb())</span>.catch(cb)
&nbsp;
