...
<head>
    <title>Code coverage report for lib/utils/update-notifier.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/utils</a> update-notifier.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">12x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// print a banner telling the user to upgrade npm to latest
