...
<head>
    <title>Code coverage report for lib/ci.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> ci.js</h1>
        <div class='clearfix'>
...
&nbsp;
const cmd = (args, cb) =&gt; ci().then(<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >cb())</span>.catch(cb)
&nbsp;
const ci = async () =&gt; {
