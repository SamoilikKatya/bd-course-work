...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> prune.js</h1>
        <div class='clearfix'>
...
&nbsp;
const cmd = (args, cb) =&gt; prune().then(<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >cb())</span>.catch(cb)
&nbsp;
const prune = async () =&gt; {
